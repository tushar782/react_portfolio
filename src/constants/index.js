...
export const EXPERIENCES = [
  {
    ...
    description: `Led a team in developing and maintaining web applications using JavaScript, Python, and Django. Implemented stored procedures and functions for data inserting and retrieving.`,
